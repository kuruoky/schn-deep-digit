...
from digit_detector import detect as detect
from digit_detector import file_io as file_io
from digit_detector import preprocess as preproc
from digit_detector import annotation as ann
from digit_detector import evaluate as eval
from digit_detector import classify as cls


model_filename = "detector_model.hdf5"
model_input_shape = (32,32,1)
DIR = '../set'
ANNOTATION_FILE = "../retrain.json"
